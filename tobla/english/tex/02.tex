...
\hypersetup{pdftitle={A Reformulation of Classical Mechanics ( I \& II )}}
...
\par \medskip\vspace{+0.36em} \noindent where ${\stackrel{\scriptscriptstyle\sim}{\smash{r}\rule{0pt}{+0.30em}}}_{\hspace{-0.12em}i}$ is the position vector of particle $i$ relative to the universal frame [\hspace{+0.120em}${\vec{\mathit{r}}}_i$ is the position vector of particle $i$, ${\vec{\mathit{R}}}$ is the position vector of the center of mass of the Universe, and ${\vec{\omega}}$ is the angular velocity vector of the Universe\hspace{+0.120em}] [\hspace{+0.120em}relative to the frame S\hspace{+0.120em}] \hyperlink{p1a1}{(\hspace{+0.120em}see {\small A}nnex {\small I}\hspace{+0.120em})}
...
\par \bigskip \noindent The net force ${\mathbf{F}}_i$ acting on a particle $i$ of mass $m_i$ produces a universal acceleration ${\mathbf{a}}_{\hspace{+0.045em}i}$ according to the following equation:
...
\par \bigskip\smallskip \noindent where ${\vec{\mathit{r}}}_i$ is the position vector of particle $i$, ${\vec{\mathit{R}}}$ is the position vector of the center of mass of the Universe, and ${\vec{\omega}}$ is the angular velocity vector of the Universe \hyperlink{p1a1}{(\hspace{+0.120em}see {\small A}nnex {\small I}\hspace{+0.120em})}
...
\par \bigskip\smallskip \noindent From the above definitions, the following relations can be obtained \hyperlink{p1a2}{(\hspace{+0.120em}see {\small A}nnex {\small II}\hspace{+0.120em})}
...
\par \bigskip \noindent A reference frame S is a special non-rotating frame when the angular velocity ${\vec{\omega}}$ of the Universe relative to S is equal to zero, and the reference frame S is also an inertial frame when the acceleration ${\vec{\mathit{A}}}$ of the center of mass of the Universe relative to S is equal to zero.

\par \bigskip \noindent If the origin of a special non-rotating frame S $[ \, {\vec{\omega}} = 0 \, ]$ always coincides with the center of mass of the Universe $[ \, {\vec{\mathit{R}}} = {\vec{\mathit{V}}} = {\vec{\mathit{A}}} = 0 \, ]$ then relative to S: $[ \, {\mathbf{r}}_i = {\vec{\mathit{r}}}_i$, ${\mathbf{v}}_i = {\vec{\mathit{v}}}_i$ and ${\mathbf{a}}_{\hspace{+0.045em}i} = {\vec{\mathit{a}}}_i \, ]$ Therefore, it is easy to see that universal magnitudes and ordinary magnitudes are always the same in the reference frame S.
...
\par \bigskip \noindent Finally, in this paper, the equation $[ \: {\mathbf{F}}_i = m_i \, {\mathbf{a}}_{\hspace{+0.045em}i} \: ]$ is valid in all reference frames (\hspace{+0.180em}inertial \hbox {or non-inertial\hspace{+0.180em})} only if all forces always obey Newton's third law in its weak form and \hbox {in its strong form.}
...
\par \medskip {\centering\subsubsection*{The Universe}}\addcontentsline{toc}{subsection}{Annex I : The Universe}\hypertarget{p1a1}{}
...
\par \medskip {\centering\subsubsection*{The Relations}}\addcontentsline{toc}{subsection}{Annex II : The Relations}\hypertarget{p1a2}{}
...
\par \medskip {\centering\subsubsection*{Frames and Forces}}\addcontentsline{toc}{subsection}{Annex IV : Frames and Forces}\hypertarget{p1a4}{}
...
\par \medskip\vspace{+0.36em} \noindent where ${\stackrel{\scriptscriptstyle\sim}{\smash{r}\rule{0pt}{+0.30em}}}_{\hspace{-0.12em}i}$ is the position vector of particle $i$ relative to the universal frame [\hspace{+0.120em}${\vec{\mathit{r}}}_i$ is the position vector of particle $i$, ${\vec{\mathit{R}}}$ is the position vector of the center of mass of the Universe, and ${\vec{\omega}}$ is the angular velocity vector of the Universe\hspace{+0.120em}] [\hspace{+0.120em}relative to the frame S\hspace{+0.120em}] \hyperlink{p2a1}{(\hspace{+0.120em}see {\small A}nnex {\small I}\hspace{+0.120em})}
...
\par \medskip \noindent $[\,3\,]$ In this paper, we assume that all dynamic forces ( all non-kinetic forces ) always obey Newton's third law in its weak form and in its strong form.
...
\par \bigskip \noindent The kinetic force ${\mathbf{K}}$ is considered in the new dynamics, mainly in the $[\,2\,]$ principle, as a new universal force of interaction.

\par \bigskip \noindent On the other hand, the kinetic force ${\mathbf{K}}$ always obey Newton's third law in its weak form or in its strong form.
...
\par \bigskip\smallskip \noindent where ${\vec{\mathit{r}}}_i$ is the position vector of particle $i$, ${\vec{\mathit{R}}}$ is the position vector of the center of mass of the Universe, and ${\vec{\omega}}$ is the angular velocity vector of the Universe \hyperlink{p2a1}{(\hspace{+0.120em}see {\small A}nnex {\small I}\hspace{+0.120em})}
...
\par \bigskip\smallskip \noindent From the above definitions, the following relations can be obtained \hyperlink{p2a2}{(\hspace{+0.120em}see {\small A}nnex {\small II}\hspace{+0.120em})}
...
\par \bigskip \noindent Finally, in this paper, the equation $[ \: {\mathbf{F}}_i = m_i \, {\mathbf{a}}_{\hspace{+0.045em}i} \: ]$ is valid in all reference frames (\hspace{+0.180em}inertial \hbox {or non-inertial\hspace{+0.180em})} only if all dynamic forces always obey Newton's third law in its weak form and in its strong form.
...
\par \medskip {\centering\subsubsection*{The Universe}}\addcontentsline{toc}{subsection}{Annex I : The Universe}\hypertarget{p2a1}{}
...
\par \medskip {\centering\subsubsection*{The Relations}}\addcontentsline{toc}{subsection}{Annex II : The Relations}\hypertarget{p2a2}{}
...
\par \medskip {\centering\subsubsection*{Frames and Forces}}\addcontentsline{toc}{subsection}{Annex IV : Frames and Forces}\hypertarget{p2a4}{}
...
\par \smallskip \noindent The net kinetic force ${\mathbf{K}}_{\hspace{+0.009em}i}$ acting on a particle $i$ of mass $m_i$ ( relative to a reference frame S fixed to a particle $s$ ( ${\vec{\mathit{r}}}_{s} = {\vec{\mathit{v}}}_{s} = {\vec{\mathit{a}}}_{s} = 0$ ) of mass $m_s$, with universal velocity ${\mathbf{v}}_s$ and universal acceleration ${\mathbf{a}}_s$ ) can also be expressed as follows:
...
\par {\centering\subsection*{\textsf{Diagram I}}}\addcontentsline{toc}{subsection}{§. Papers I \& II (A)}

\vspace{+1.8em}

\newcommand{\cafa}{\textsf{Paper I}}
\newcommand{\cafb}{\textsf{Paper II}}
\newcommand{\cbfu}{\textsf{Newton's Law III \vspace{0.6em} \\ ( True )}}
\newcommand{\ccfu}{\textsf{Auxiliary system of particles \vspace{0.6em} \\ Universe}}
\newcommand{\cdfu}{\textsf{Invariant Magnitudes} \vspace{0.6em} \\ \textsf{Universal position} : ${\mathbf{r}}_i$ \vspace{0.15em} \\ \textsf{Universal velocity} : ${\mathbf{v}}_i$ \vspace{0.15em} \\ \textsf{Universal acceleration} : ${\mathbf{a}}_{\hspace{+0.045em}i}$}
\newcommand{\cefb}{\textsf{Kinetic force} \vspace{0.9em} \\ ${\mathbf{K}}_{\hspace{+0.060em}ij} = - \; \dfrac{m_i \, m_j}{\mathit{M}} \, (\hspace{+0.045em}{\mathbf{a}}_{\hspace{+0.045em}i} - {\mathbf{a}}_{j})$ \vspace{+0.81em} \\ \textsf{Net kinetic force} \vspace{0.6em} \\ ${\mathbf{K}}_{i} = - \; m_i \, {\mathbf{a}}_{\hspace{+0.045em}i}$}
...
\par {\centering\subsection*{\textsf{Diagram II}}}\addcontentsline{toc}{subsection}{§. Papers I \& II (B)}

\vspace{+1.8em}

\newcommand{\vaha}{\textsf{Paper I}}
\newcommand{\vahb}{\textsf{Paper II}}
