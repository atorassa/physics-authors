...
\hypersetup{pdftitle={Mecánica Clásica Angular}}
...
\parbox{96mm}{Este trabajo presenta una mecánica clásica angular, que puede ser aplicada en cualquier sistema de referencia (rotante o no rotante) (inercial o no inercial) sin necesidad de introducir fuerzas ficticias.}
...
\par La posición $\vR$, la velocidad $\vV$ y la aceleración $\vA$ de una sola partícula de masa $\mM$, están dadas por:
\bigskip
\begin{center}
\begin{tabular}{l}
...
\end{center}
\bigskip
\noindent donde $\vR$ es el vector posición de la partícula.
\medskip
\par Y la posición dinámica $\bre\vR$, la velocidad dinámica $\bre\vV$ y la aceleración dinámica $\bre\vA$, están dadas por:
\medskip
\begin{center}
\begin{tabular}{l}
...
\end{center}
\medskip
\noindent donde $\vF$ es la fuerza resultante que actúa sobre la partícula.
...
\par Dadas dos partículas i y j entonces para un sistema de referencia S las ecuaciones de movimiento son:
\vspace{-0.15em}
...
\vspace{+0.30em}
\par Ahora, como $(\vR \times \bre\vV\rij) = \int (\vR \times \bre\vA\rij) \hspace{+0.18em} dt$, y $(\vR \times \bre\vV\rij) \cdot (\vR \times \bre\vV\rij) = 2 \int (\vR \times \bre\vA\rij) \cdot d(\vR \times \bre\vR\rij)$, entonces:
\vspace{+1.50em}
\par $\med \hspace{+0.15em} \mM\ri\hspace{+0.09em}\mM\rj \hspace{+0.12em} \big[ \hspace{+0.12em} (\vR \times \vR\rij) \cdot (\vR \times \vR\rij) - (\vR \times \bre\vR\rij) \cdot (\vR \times \bre\vR\rij) \hspace{+0.12em} \big] = \hspace{+0.12em} 0$ \\
\vspace{+0.30em}
...
\vspace{+0.30em}
\par \noindent donde $\vR\rij = \vR\ri - \vR\rj$, $\vV\rij = \vV\ri - \vV\rj$, $\vA\rij = \vA\ri - \vA\rj$, $\bre\vR\rij = \bre\vR\ri - \bre\vR\rj$, $\bre\vV\rij = \bre\vV\ri - \bre\vV\rj$, $\bre\vA\rij = \bre\vA\ri - \bre\vA\rj$, $\mM\ri$ y $\mM\rj$ son las masas de las partículas i y j, $\vR\ri$, $\vR\rj$, $\vV\ri$, $\vV\rj$, $\vA\ri$ y $\vA\rj$ son las posiciones, las velocidades y las aceleraciones de las partículas i y j, y $\bre\vR\ri$, $\bre\vR\rj$, $\bre\vV\ri$, $\bre\vV\rj$, $\bre\vA\ri$ y $\bre\vA\rj$ son las posiciones dinámicas, las velocidades dinámicas y las aceleraciones dinámicas de las partículas i y j.
\vspace{+0.60em}
\par \noindent $\vR$ es un vector posición definido por dos puntos fijos 1 y 2 del sistema de referencia S ($\vR = \vR_1 - \vR_2$) en el que la aceleración dinámica del punto 1 es igual a la aceleración dinámica del punto 2 ($\bre\vA_1 = \bre\vA_2$)
...
\bigskip
\par El sistema de referencia universal es un sistema de referencia fijo al centro de masa del universo (si la fuerza resultante que actúa sobre el centro de masa del universo es siempre cero)
...
\bigskip
\par Las ecuaciones de movimiento serían válidas incluso si la tercera ley de movimiento de Newton fuera falsa en un sistema de referencia inercial.
\bigskip
\par Las ecuaciones de movimiento serían válidas incluso si las tres leyes de movimiento de Newton fueran falsas en un sistema de referencia no inercial.
\bigskip
\par Las ecuaciones de movimiento son ecuaciones de transformación entre sistemas de referencia y pueden obtenerse desde la ecuación general de movimiento ( \hspace{-0.45em} \textbf{A. Torassa}, Ecuación General de Movimiento \hspace{-0.45em} )
