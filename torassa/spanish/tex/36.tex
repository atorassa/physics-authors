...
\hypersetup{pdftitle={Mecánica Clásica Universal}}
...
{\huge Mecánica Clásica Universal}
...
\parbox{99mm}{Este trabajo presenta una mecánica clásica universal, que puede ser aplicada en cualquier sistema de referencia (rotante o no rotante) (inercial o no inercial) sin necesidad de introducir fuerzas ficticias.}
...
\par Si consideramos dos partículas i y j entonces las ecuaciones de movimiento están dadas por:
\vspace{+1.50em}
...
\vspace{+1.80em}
\par Ahora, como $\bre\vV\rij = \int \bre\vA\rij \hspace{+0.18em} dt$, y $\bre\vV\rij \cdot \bre\vV\rij = 2 \int \bre\vA\rij \cdot d\bre\vR\rij$, entonces nosotros obtenemos:
\vspace{+1.50em}
\par \hspace{+3.09em} $\med \hspace{+0.15em} \mM\ri\hspace{+0.09em}\mM\rj \hspace{+0.12em} \big[ \hspace{+0.12em} \vR\rij \cdot \vR\rij - \bre\vR\rij \cdot \bre\vR\rij \hspace{+0.12em} \big] = \hspace{+0.12em} 0$ \\
\vspace{+0.60em}
